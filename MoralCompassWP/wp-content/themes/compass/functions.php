...
function my_login_logo() { ?>
    <style type="text/css">
        body.login div#login h1 a {
            background-image: url(<?php echo get_bloginfo( 'template_directory' ) ?>/img/site-login-logo.jpg);
            padding-bottom: 30px;
        }
    </style>
<?php }
...
function add_login_logout_link($items, $args)
{
	...
	{
		$newitems = $items;
		$newitems .= '<li><a title="Login" href="'. wp_login_url($_SERVER['REQUEST_URI']) .'">Login</a></li>';
	}
